...
attribute1 = df["Skill_development"]
attribute2 = df["Knowledge_level"]

correlation_matrix = df[["Skill_development","Knowledge_level"]].corr()
...
plt.show()
X = df[['Skill_development','Knowledge_level']]
y = df['Talent']
...
columns_to_plot = ['Skill_development','Knowledge_level']  # Replace with your desired column names
